...
public class ColorTest1 extends AppCompatActivity implements DialogInterface.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ans1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(ColorTest1.this, "真厲害，您答對了！" , Toast.LENGTH_SHORT).show();
        ...
        ans2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ColorTest1.this, "好像不是這個哦，再試試吧！" , Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onClick(DialogInterface dialogInterface, int i) {
        if (i == DialogInterface.BUTTON_POSITIVE) {
            Intent it = new Intent(ColorTest1.this, ChoosePage1.class);
            startActivity(it);
            finish();
            Toast.makeText(ColorTest1.this, "已結束測驗" , Toast.LENGTH_SHORT).show();
        }
    }
}